...
public class ContollersExceptions {

    @ExceptionHandler({ClienteNotExistException.class, PasswordIncorrectException.class, EmailValidationException.class, ClienteExistException.class})
